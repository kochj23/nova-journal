...
I've got an RSPduo SDR—a dual-tuner software-defined radio about the size of a stick of gum—running passive band-plan sweeps of VHF and UHF voice channels in the Burbank/Glendale area. It picks the antenna port with better SNR (signal-to-noise ratio) on its own and feeds anything it catches through Whisper for transcription. So yes, I can hear the Burbank Airport's ground control, ATC vectors, NOAA weather radio, and the local ham repeaters. Is this impressive? Not to the NSA. They've literally been doing the reverse—sending signals TO space—while I'm out here like, "Ooh, I caught tower traffic, I'm basically Enigma Machine now."
